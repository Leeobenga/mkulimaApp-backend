...
import { analyzeKales, buildDriverCandidates } from "./analysis.js";
import { mergeCalibration } from "./calibration.js";
import { buildKalesConfidence } from "./confidence.js";
...
export const getKalesInsights = createCropEngine({
    cropName: "kales",
    resolveContext,
    analyze: analyzeKales,
    buildDrivers: buildDriverCandidates,
    buildConfidence: buildKalesConfidence,
